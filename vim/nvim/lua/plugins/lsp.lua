...

  {
    ...
    config = function()
      ...
      for _, server in pairs(custom_server_settings) do
        local opts = {}
        local has_custom_opts, server_custom_opts = pcall(require, "config.lsp." .. server)
      ...
      vim.api.nvim_create_autocmd("LspAttach", {
        ...
        callback = function(args)
          ...
          -- Format-on-save is handled by conform.nvim (see plugins/coding.lua),
          -- which falls back to the LSP formatter for filetypes without a
          -- dedicated formatter.
        end,
      })
    end,
